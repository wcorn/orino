...
export const importTripPrep = () =>
  import("../pages/travel/TripPrepPage").then((m) => ({
    default: m.TripPrepPage,
  }));
export const importTripExpenses = () =>
...
export const importLedgerImport = () =>
  import("../pages/ledger/LedgerImportPage").then((m) => ({
    default: m.LedgerImportPage,
  }));
/**
